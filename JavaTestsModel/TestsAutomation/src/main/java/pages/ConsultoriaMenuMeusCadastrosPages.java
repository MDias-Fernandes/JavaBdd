...
public class ConsultoriaMenuMeusCadastrosPages {
	...
	static By submenuSuggestedForStart 		= By.xpath("//div[starts-with(@style,'display: flex;')][contains(text(), 'Sugeridas para início')]");
	static By submenuWaitForFirstOrder 		= By.xpath("//div[starts-with(@style,'display: flex;')][contains(text(), 'Aguardando 1° pedido')]");
	static By submenuInicial 				= By.xpath("//div[starts-with(@style,'display: flex;')][contains(text(), 'Inícios')]");
	static By submenuReprovedAbandon		= By.xpath("//div[starts-with(@style,'display: flex;')][contains(text(), 'Reprovados/ Desistência')]");
	...
	static By screenTitleSuggestedForStart	= By.xpath("//div[starts-with(@class,'HeaderTop__')][contains(text(), 'Sugeridas para início')]");
	static By screenWaitForFirstOrder		= By.xpath("//div[starts-with(@class,'HeaderTop__')][contains(text(), 'Aguardando 1° pedido')]");
	static By screenInicials				= By.xpath("//div[starts-with(@class,'HeaderTop__')][contains(text(), 'Inícios')]");
	static By screenReprovedAbandon			= By.xpath("//div[starts-with(@class,'HeaderTop__')][contains(text(), 'Reprovados/ Desistência')]");
